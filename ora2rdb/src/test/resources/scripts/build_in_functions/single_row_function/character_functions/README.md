...
Отличия в пустой строке. Если в оракле задать пустую строку, то результатом будет NULL, а у нас - 0. Для этого функция оборачивается в функцию DECODE так, чтобы при пустой строке возвращалось значение NULL
